...
> [!IMPORTANT]
> Repositories under [craquehouse](https://github.com/craquehouse) do **not** accept pull requests that are fully or predominantly AI-generated. AI tools may be used solely in an assistive capacity.
>
> Repeated violations of this policy may result in your account being permanently banned from contributing.

Content that is initially generated by AI and subsequently edited is still considered AI-generated. AI assistance is permissible only when the majority of the contribution is authored by a human, with AI employed exclusively for corrections or to expand on verbose modifications the contributor has already conceptualized (e.g., generating repeated lines with minor variations).
